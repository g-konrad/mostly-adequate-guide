...
Em programação funcional, não gostamos de funções bagunceiras como `splice`, que *mudam* seus dados. Queremos funções confiáveis, que retornam o mesmo resultado sempre, não funções que causam um estrago por onde passam como `splice`.
